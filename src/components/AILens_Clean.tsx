...
export const AILens: React.FC = () => {
  ...
  return (
    <div className="container-mobile min-h-screen bg-slate-900 text-white relative overflow-hidden">
      <BackgroundAurora className="absolute inset-0" />
                ...
                >
                  <div className="flex items-start justify-between">
                    <div className="flex items-start gap-3">
                      <div className="w-6 h-6 sm:w-8 sm:h-8 bg-indigo-500/20 rounded-lg flex items-center justify-center flex-shrink-0">
